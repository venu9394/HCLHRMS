...
<div class="w3-container">
   ...
   <td> <a href="ExcelDownload?type=query1&&name=a.permanentaddress&&LOGINBY=<%=LOGINBY%>"  style='text-decoration:none;'" > Download <i class="fa fa-download"></i> </a></td>
   <td>Department </td>
   <td><div class="tooltip"> <i class="fa fa-external-link-square"> <span id='DEPART'> </span> </i>
   <span class="tooltiptext" id='DEPART_T'> 
   </span>
   </div></td>
   <td><a href="ExcelDownload?type=query3&&name=a.departmentid&&LOGINBY=<%=LOGINBY%>" style='text-decoration:none;' > Download<i class="fa fa-download"></i> </a> </td>
   ...
   <td> <a href="ExcelDownload?type=query2&&name=a.accountno&&LOGINBY=<%=LOGINBY%>" style='text-decoration:none;'> Download <i class="fa fa-download"></i> </a> </td>
   </tr>
   <tr>
   <td>Mobile Number</td>
   <td><div class="tooltip"><i class="fa fa-external-link-square"> <span id='MOB'></span> </i><span class="tooltiptext" id='MOB_T' > </span></div></td>
   <td> <a href="ExcelDownload?type=query1&&name=a.mobile&&LOGINBY=<%=LOGINBY%>" style='text-decoration:none;' > Download <i class="fa fa-download"> </i> </a></td>
   <td>Designation</td>
   ...
   <td> <a href="ExcelDownload?type=query3&&name=a.designationid&&LOGINBY=<%=LOGINBY%>" style='text-decoration:none;' > Download<i class="fa fa-download"></i> </a></td>
   <td>PF No</td>
   <td><div class="tooltip"><i class="fa fa-external-link-square"><span id='PF'></span></i><span class="tooltiptext" id='PF_T'> </span></div></td>
   <td> <a href="ExcelDownload?type=query2&&name=a.pfno&&LOGINBY=<%=LOGINBY%>" style='text-decoration:none;'> Download <i class="fa fa-download"></i> </a></td>
   </tr>
   <tr>
   <td>E-Mail Id's</td>
   ...
   <td><a href="ExcelDownload?type=query1&&name=a.email&&LOGINBY=<%=LOGINBY%>" style='text-decoration:none;'> Download<i class="fa fa-download"></i> </a></td>
   <td>Work Location</td>
   <td><div class="tooltip">
   <i class="fa fa-external-link-square"> <span id='WLC' > </span> </i>
    <span class="tooltiptext" id='WLC_T'> </span>
   </div></td>
   <td> <a href="ExcelDownload?type=query3&&name=a.worklocationid&&LOGINBY=<%=LOGINBY%>" style='text-decoration:none;'  > Download<i class="fa fa-download"></i> </a> </td>
   <td>ESI Number</td>
   <td><div class="tooltip"><i class="fa fa-external-link-square"> <span id='ESI'></span> </i><span class="tooltiptext" id='ESI_T'></span></div></td>
   <td><a href="ExcelDownload?type=query2&&name=a.esino&&LOGINBY=<%=LOGINBY%>" style='text-decoration:none;' > Download<i class="fa fa-download"></i> </a></td>
   </tr>
  </table>
</div>
</body>
