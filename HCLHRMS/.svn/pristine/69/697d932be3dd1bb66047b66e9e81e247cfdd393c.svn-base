 ...
 */
public class Bank_services extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  //****************************************************************************  
	   ...
	   /*emp_lop.append(" select a.employeesequenceno,b.employeeid,b.bankid,b.accountno ");
	    ...
	    emp_lop.append(" where a.employeeid=b.employeeid and a.status=1001 and a.companyid="+BU+"   ");*/
		 ...
		 emp_lop.append(" select a.employeesequenceno,b.employeeid,b.bankid,b.accountno,ifnull(c.BANKIFC,0) IFC ");
		 emp_lop.append(" from hclhrm_prod.tbl_employee_primary a ");
		 emp_lop.append(" left join hclhrm_prod.TBL_EMPLOYEE_OTHER_DETAIL b on a.employeeid=b.employeeid ");
		 emp_lop.append(" left join hclhrm_prod_others.tbl_emp_bank_ifc c on c.EMPID=b.employeeid ");
		 emp_lop.append("  where  a.status=1001  and  a.companyid="+BU+" ");
	    ...
	    try {
			...
			while(Res.next()){
				...
				Emp_Data.put(Res.getString("employeeid")+"_IFC", "0");
	    ...
	    try {
			...
			while(Res.next()){
				...
				Emp_Data.put(Res.getString("employeeid")+"_BANKID", Res.getString("bankid")); // From LOP Master
				Emp_Data.put(Res.getString("employeeid")+"_BANKACC", Res.getString("accountno")); // From LOP Master
				Emp_Data.put(Res.getString("employeeid")+"_IFC", Res.getString("IFC"));
	    ...
	    try {
			...
			while(Res.next()){
				 ...
				 jason = new JSONObject();
				  ...
				  jason.put("IFC", Emp_Data.get(Res.getString("employeeid")+"_IFC"));
	  ...
	  //**************************************************************************** 
	    ...
	    request.getRequestDispatcher("Bank_update_emp.jsp").forward(request, response);
	}
