 ...
 */
public class LOP_Db_insertion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LOP_Db_insertion() {
        super();
	...
	//******************************************************************************
		...
		Enumeration EMPLOYEE_SEQ_NUM1=request.getParameterNames();
		
		String Param=null,Param_lopval="0";
		
		System.out.println(EMPLOYEE_SEQ_NUM +":EMPLOYEE_SEQ_NUM");
	
		while(EMPLOYEE_SEQ_NUM1.hasMoreElements()){
			Param_lopval="0";
			Param=EMPLOYEE_SEQ_NUM1.nextElement().toString();
