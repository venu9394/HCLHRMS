...
<script type="text/javascript">
    $(document).ready(function(){
     ...
     <%-- var Data=JSON.parse('<%=EMP_LOPLIST%>'); --%>
    	 ...
    	 for(var i=0;i<Data.length;i++){
            ...
            var email = $("#email").val();
            j++;
            var markup = "<tr><td> "+j+" </td><td>" + tempjason.SEQNO + "</td><td>" + tempjason.CALLNAME + "</td><td>" + tempjason.DATEOFJOIN + "</td><td> <input type='text' value='"+tempjason.LOP+"' name='"+tempjason.EMPID+"' id='" + tempjason.EMPID + "'  <%=Mode%> onkeypress='return RateisNumber(event,this)' style='width:50px' /> </td> <td></td> <td></td> <td></td> </tr>";
 ...
 function myFunction() {
   ...
   var idR1=document.getElementById("radio1");
   var idR2=document.getElementById("radio2");
   var SearchIndex=1;
    
   //alert(idR1.checked);
   if(idR1.checked){
	   SearchIndex=2;
   }else if(idR2.checked){
	   SearchIndex=1;
   } 
...
<div style='widht:400px;height:480px;overflow:scroll;'  >
 ...
 <div align='right'>
    ...
    Search By Name<input type='radio'  name='r' id="radio1" value='2' />
    EmployeeID  <input type='radio'  name='r'  id="radio2" value='1' checked/> 
